...
public class CommonAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
                      @Optional("OS X") String os, @Optional("10") String os_version, @Optional("chrome-options") String browserName, @Optional("34")
                              String browserVersion, @Optional("https://www.nytimes.com/") String url)throws IOException {
        ...
        if(useCloudEnv==true){
            ...
            System.setProperty("webdriver.chrome.driver", "/Users/fahim/IdeaProjects2/Team-Automation-Framework2019/drivers/chromedriver");
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.chrome.driver", "/Users/fahim/IdeaProjects2/Team-Automation-Framework2019/drivers/geckodriver");
            }else if(OS.equalsIgnoreCase("Windows")){
                System.setProperty("webdriver.chrome.driver", "../Generic/drivers/chromedriver.exe");
            }
